...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/NXPMotionSense/examples/CalibrateSensors/CalibrateSensors.ino 

OBJS += \
./Libraries/NXPMotionSense/examples/CalibrateSensors/CalibrateSensors.o 

INO_DEPS += \
./Libraries/NXPMotionSense/examples/CalibrateSensors/CalibrateSensors.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/NXPMotionSense/examples/CalibrateSensors/CalibrateSensors.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/NXPMotionSense/examples/CalibrateSensors/CalibrateSensors.ino
	@echo 'Building file: $<'
