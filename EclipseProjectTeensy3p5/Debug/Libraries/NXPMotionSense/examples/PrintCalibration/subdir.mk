...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/NXPMotionSense/examples/PrintCalibration/PrintCalibration.ino 

OBJS += \
./Libraries/NXPMotionSense/examples/PrintCalibration/PrintCalibration.o 

INO_DEPS += \
./Libraries/NXPMotionSense/examples/PrintCalibration/PrintCalibration.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/NXPMotionSense/examples/PrintCalibration/PrintCalibration.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/NXPMotionSense/examples/PrintCalibration/PrintCalibration.ino
	@echo 'Building file: $<'
