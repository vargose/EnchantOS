...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/NXPMotionSense/examples/MahonyIMU/MahonyIMU.ino 

OBJS += \
./Libraries/NXPMotionSense/examples/MahonyIMU/MahonyIMU.o 

INO_DEPS += \
./Libraries/NXPMotionSense/examples/MahonyIMU/MahonyIMU.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/NXPMotionSense/examples/MahonyIMU/MahonyIMU.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/NXPMotionSense/examples/MahonyIMU/MahonyIMU.ino
	@echo 'Building file: $<'
