...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/NXPMotionSense/examples/Orientation/Orientation.ino 

OBJS += \
./Libraries/NXPMotionSense/examples/Orientation/Orientation.o 

INO_DEPS += \
./Libraries/NXPMotionSense/examples/Orientation/Orientation.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/NXPMotionSense/examples/Orientation/Orientation.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/NXPMotionSense/examples/Orientation/Orientation.ino
	@echo 'Building file: $<'
