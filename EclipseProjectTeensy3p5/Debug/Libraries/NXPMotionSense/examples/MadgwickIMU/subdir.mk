...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/NXPMotionSense/examples/MadgwickIMU/MadgwickIMU.ino 

OBJS += \
./Libraries/NXPMotionSense/examples/MadgwickIMU/MadgwickIMU.o 

INO_DEPS += \
./Libraries/NXPMotionSense/examples/MadgwickIMU/MadgwickIMU.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/NXPMotionSense/examples/MadgwickIMU/MadgwickIMU.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/NXPMotionSense/examples/MadgwickIMU/MadgwickIMU.ino
	@echo 'Building file: $<'
