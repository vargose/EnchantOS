...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Bounce2/examples/bounce/bounce.ino 

OBJS += \
./Libraries/Bounce2/examples/bounce/bounce.o 

INO_DEPS += \
./Libraries/Bounce2/examples/bounce/bounce.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Bounce2/examples/bounce/bounce.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Bounce2/examples/bounce/bounce.ino
	@echo 'Building file: $<'
