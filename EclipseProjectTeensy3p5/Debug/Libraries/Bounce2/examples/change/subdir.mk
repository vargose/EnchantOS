...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Bounce2/examples/change/change.ino 

OBJS += \
./Libraries/Bounce2/examples/change/change.o 

INO_DEPS += \
./Libraries/Bounce2/examples/change/change.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Bounce2/examples/change/change.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Bounce2/examples/change/change.ino
	@echo 'Building file: $<'
