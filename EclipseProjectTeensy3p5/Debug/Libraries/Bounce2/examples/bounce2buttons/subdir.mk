...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Bounce2/examples/bounce2buttons/bounce2buttons.ino 

OBJS += \
./Libraries/Bounce2/examples/bounce2buttons/bounce2buttons.o 

INO_DEPS += \
./Libraries/Bounce2/examples/bounce2buttons/bounce2buttons.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Bounce2/examples/bounce2buttons/bounce2buttons.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Bounce2/examples/bounce2buttons/bounce2buttons.ino
	@echo 'Building file: $<'
