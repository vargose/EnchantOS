...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Bounce2/examples/retrigger/retrigger.ino 

OBJS += \
./Libraries/Bounce2/examples/retrigger/retrigger.o 

INO_DEPS += \
./Libraries/Bounce2/examples/retrigger/retrigger.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Bounce2/examples/retrigger/retrigger.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Bounce2/examples/retrigger/retrigger.ino
	@echo 'Building file: $<'
