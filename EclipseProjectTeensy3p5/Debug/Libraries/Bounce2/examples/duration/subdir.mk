...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Bounce2/examples/duration/duration.ino 

OBJS += \
./Libraries/Bounce2/examples/duration/duration.o 

INO_DEPS += \
./Libraries/Bounce2/examples/duration/duration.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Bounce2/examples/duration/duration.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Bounce2/examples/duration/duration.ino
	@echo 'Building file: $<'
