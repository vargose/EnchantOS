...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/FastLED/examples/RGBCalibrate/RGBCalibrate.ino 

OBJS += \
./Libraries/FastLED/examples/RGBCalibrate/RGBCalibrate.o 

INO_DEPS += \
./Libraries/FastLED/examples/RGBCalibrate/RGBCalibrate.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/FastLED/examples/RGBCalibrate/RGBCalibrate.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/FastLED/examples/RGBCalibrate/RGBCalibrate.ino
	@echo 'Building file: $<'
