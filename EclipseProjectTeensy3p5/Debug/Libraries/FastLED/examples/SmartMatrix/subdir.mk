...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/FastLED/examples/SmartMatrix/SmartMatrix.ino 

OBJS += \
./Libraries/FastLED/examples/SmartMatrix/SmartMatrix.o 

INO_DEPS += \
./Libraries/FastLED/examples/SmartMatrix/SmartMatrix.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/FastLED/examples/SmartMatrix/SmartMatrix.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/FastLED/examples/SmartMatrix/SmartMatrix.ino
	@echo 'Building file: $<'
