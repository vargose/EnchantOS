...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/FastLED/examples/NoisePlayground/NoisePlayground.ino 

OBJS += \
./Libraries/FastLED/examples/NoisePlayground/NoisePlayground.o 

INO_DEPS += \
./Libraries/FastLED/examples/NoisePlayground/NoisePlayground.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/FastLED/examples/NoisePlayground/NoisePlayground.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/FastLED/examples/NoisePlayground/NoisePlayground.ino
	@echo 'Building file: $<'
