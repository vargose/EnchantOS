...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/FastLED/examples/FirstLight/FirstLight.ino 

OBJS += \
./Libraries/FastLED/examples/FirstLight/FirstLight.o 

INO_DEPS += \
./Libraries/FastLED/examples/FirstLight/FirstLight.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/FastLED/examples/FirstLight/FirstLight.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/FastLED/examples/FirstLight/FirstLight.ino
	@echo 'Building file: $<'
