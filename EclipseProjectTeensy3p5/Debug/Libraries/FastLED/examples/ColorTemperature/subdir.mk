...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/FastLED/examples/ColorTemperature/ColorTemperature.ino 

OBJS += \
./Libraries/FastLED/examples/ColorTemperature/ColorTemperature.o 

INO_DEPS += \
./Libraries/FastLED/examples/ColorTemperature/ColorTemperature.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/FastLED/examples/ColorTemperature/ColorTemperature.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/FastLED/examples/ColorTemperature/ColorTemperature.ino
	@echo 'Building file: $<'
