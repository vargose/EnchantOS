...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/FastLED/examples/XYMatrix/XYMatrix.ino 

OBJS += \
./Libraries/FastLED/examples/XYMatrix/XYMatrix.o 

INO_DEPS += \
./Libraries/FastLED/examples/XYMatrix/XYMatrix.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/FastLED/examples/XYMatrix/XYMatrix.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/FastLED/examples/XYMatrix/XYMatrix.ino
	@echo 'Building file: $<'
