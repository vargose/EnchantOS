...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/FastLED/examples/Cylon/Cylon.ino 

OBJS += \
./Libraries/FastLED/examples/Cylon/Cylon.o 

INO_DEPS += \
./Libraries/FastLED/examples/Cylon/Cylon.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/FastLED/examples/Cylon/Cylon.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/FastLED/examples/Cylon/Cylon.ino
	@echo 'Building file: $<'
