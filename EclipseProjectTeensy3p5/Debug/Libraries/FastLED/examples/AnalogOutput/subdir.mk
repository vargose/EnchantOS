...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/FastLED/examples/AnalogOutput/AnalogOutput.ino 

OBJS += \
./Libraries/FastLED/examples/AnalogOutput/AnalogOutput.o 

INO_DEPS += \
./Libraries/FastLED/examples/AnalogOutput/AnalogOutput.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/FastLED/examples/AnalogOutput/AnalogOutput.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/FastLED/examples/AnalogOutput/AnalogOutput.ino
	@echo 'Building file: $<'
