...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/FastLED/examples/Pintest/Pintest.ino 

OBJS += \
./Libraries/FastLED/examples/Pintest/Pintest.o 

INO_DEPS += \
./Libraries/FastLED/examples/Pintest/Pintest.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/FastLED/examples/Pintest/Pintest.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/FastLED/examples/Pintest/Pintest.ino
	@echo 'Building file: $<'
