...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/FastLED/examples/RGBSetDemo/RGBSetDemo.ino 

OBJS += \
./Libraries/FastLED/examples/RGBSetDemo/RGBSetDemo.o 

INO_DEPS += \
./Libraries/FastLED/examples/RGBSetDemo/RGBSetDemo.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/FastLED/examples/RGBSetDemo/RGBSetDemo.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/FastLED/examples/RGBSetDemo/RGBSetDemo.ino
	@echo 'Building file: $<'
