...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/FastLED/examples/ColorPalette/ColorPalette.ino 

OBJS += \
./Libraries/FastLED/examples/ColorPalette/ColorPalette.o 

INO_DEPS += \
./Libraries/FastLED/examples/ColorPalette/ColorPalette.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/FastLED/examples/ColorPalette/ColorPalette.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/FastLED/examples/ColorPalette/ColorPalette.ino
	@echo 'Building file: $<'
