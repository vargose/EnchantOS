...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/FastLED/examples/Multiple/ParallelOutputDemo/ParallelOutputDemo.ino 

OBJS += \
./Libraries/FastLED/examples/Multiple/ParallelOutputDemo/ParallelOutputDemo.o 

INO_DEPS += \
./Libraries/FastLED/examples/Multiple/ParallelOutputDemo/ParallelOutputDemo.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/FastLED/examples/Multiple/ParallelOutputDemo/ParallelOutputDemo.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/FastLED/examples/Multiple/ParallelOutputDemo/ParallelOutputDemo.ino
	@echo 'Building file: $<'
