...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/FastLED/examples/Noise/Noise.ino 

OBJS += \
./Libraries/FastLED/examples/Noise/Noise.o 

INO_DEPS += \
./Libraries/FastLED/examples/Noise/Noise.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/FastLED/examples/Noise/Noise.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/FastLED/examples/Noise/Noise.ino
	@echo 'Building file: $<'
