...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/SD/examples/ReadWrite/ReadWrite.ino 

OBJS += \
./Libraries/SD/examples/ReadWrite/ReadWrite.o 

INO_DEPS += \
./Libraries/SD/examples/ReadWrite/ReadWrite.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/SD/examples/ReadWrite/ReadWrite.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/SD/examples/ReadWrite/ReadWrite.ino
	@echo 'Building file: $<'
