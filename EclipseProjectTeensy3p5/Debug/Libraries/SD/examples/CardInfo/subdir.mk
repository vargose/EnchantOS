...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/SD/examples/CardInfo/CardInfo.ino 

OBJS += \
./Libraries/SD/examples/CardInfo/CardInfo.o 

INO_DEPS += \
./Libraries/SD/examples/CardInfo/CardInfo.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/SD/examples/CardInfo/CardInfo.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/SD/examples/CardInfo/CardInfo.ino
	@echo 'Building file: $<'
