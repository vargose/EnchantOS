...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/SD/examples/listfiles/listfiles.ino 

OBJS += \
./Libraries/SD/examples/listfiles/listfiles.o 

INO_DEPS += \
./Libraries/SD/examples/listfiles/listfiles.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/SD/examples/listfiles/listfiles.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/SD/examples/listfiles/listfiles.ino
	@echo 'Building file: $<'
