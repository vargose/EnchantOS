...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/SD/examples/DumpFile/DumpFile.ino 

OBJS += \
./Libraries/SD/examples/DumpFile/DumpFile.o 

INO_DEPS += \
./Libraries/SD/examples/DumpFile/DumpFile.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/SD/examples/DumpFile/DumpFile.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/SD/examples/DumpFile/DumpFile.ino
	@echo 'Building file: $<'
