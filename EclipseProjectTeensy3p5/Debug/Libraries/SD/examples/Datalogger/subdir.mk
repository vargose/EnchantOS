...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/SD/examples/Datalogger/Datalogger.ino 

OBJS += \
./Libraries/SD/examples/Datalogger/Datalogger.o 

INO_DEPS += \
./Libraries/SD/examples/Datalogger/Datalogger.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/SD/examples/Datalogger/Datalogger.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/SD/examples/Datalogger/Datalogger.ino
	@echo 'Building file: $<'
