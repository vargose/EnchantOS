...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Snooze/examples/hibernate/button_hold_wakeup/button_hold_wakeup.ino 

OBJS += \
./Libraries/Snooze/examples/hibernate/button_hold_wakeup/button_hold_wakeup.o 

INO_DEPS += \
./Libraries/Snooze/examples/hibernate/button_hold_wakeup/button_hold_wakeup.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Snooze/examples/hibernate/button_hold_wakeup/button_hold_wakeup.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Snooze/examples/hibernate/button_hold_wakeup/button_hold_wakeup.ino
	@echo 'Building file: $<'
