...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Snooze/examples/deepsleep/deepSleep_all_wakeups/deepSleep_all_wakeups.ino 

OBJS += \
./Libraries/Snooze/examples/deepsleep/deepSleep_all_wakeups/deepSleep_all_wakeups.o 

INO_DEPS += \
./Libraries/Snooze/examples/deepsleep/deepSleep_all_wakeups/deepSleep_all_wakeups.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Snooze/examples/deepsleep/deepSleep_all_wakeups/deepSleep_all_wakeups.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Snooze/examples/deepsleep/deepSleep_all_wakeups/deepSleep_all_wakeups.ino
	@echo 'Building file: $<'
