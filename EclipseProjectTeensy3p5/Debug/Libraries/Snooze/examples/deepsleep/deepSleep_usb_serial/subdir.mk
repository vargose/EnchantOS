...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Snooze/examples/deepsleep/deepSleep_usb_serial/deepSleep_usb_serial.ino 

OBJS += \
./Libraries/Snooze/examples/deepsleep/deepSleep_usb_serial/deepSleep_usb_serial.o 

INO_DEPS += \
./Libraries/Snooze/examples/deepsleep/deepSleep_usb_serial/deepSleep_usb_serial.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Snooze/examples/deepsleep/deepSleep_usb_serial/deepSleep_usb_serial.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Snooze/examples/deepsleep/deepSleep_usb_serial/deepSleep_usb_serial.ino
	@echo 'Building file: $<'
