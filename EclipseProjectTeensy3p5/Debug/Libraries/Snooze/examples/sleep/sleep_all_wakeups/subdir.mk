...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Snooze/examples/sleep/sleep_all_wakeups/sleep_all_wakeups.ino 

OBJS += \
./Libraries/Snooze/examples/sleep/sleep_all_wakeups/sleep_all_wakeups.o 

INO_DEPS += \
./Libraries/Snooze/examples/sleep/sleep_all_wakeups/sleep_all_wakeups.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Snooze/examples/sleep/sleep_all_wakeups/sleep_all_wakeups.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Snooze/examples/sleep/sleep_all_wakeups/sleep_all_wakeups.ino
	@echo 'Building file: $<'
