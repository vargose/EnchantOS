...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Snooze/examples/sleep/sleep_usb_serial/sleep_usb_serial.ino 

OBJS += \
./Libraries/Snooze/examples/sleep/sleep_usb_serial/sleep_usb_serial.o 

INO_DEPS += \
./Libraries/Snooze/examples/sleep/sleep_usb_serial/sleep_usb_serial.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Snooze/examples/sleep/sleep_usb_serial/sleep_usb_serial.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Snooze/examples/sleep/sleep_usb_serial/sleep_usb_serial.ino
	@echo 'Building file: $<'
