...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/HardwareTesting/PassThroughQuad/PassThroughQuad.ino 

OBJS += \
./Libraries/Audio/examples/HardwareTesting/PassThroughQuad/PassThroughQuad.o 

INO_DEPS += \
./Libraries/Audio/examples/HardwareTesting/PassThroughQuad/PassThroughQuad.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Audio/examples/HardwareTesting/PassThroughQuad/PassThroughQuad.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/HardwareTesting/PassThroughQuad/PassThroughQuad.ino
	@echo 'Building file: $<'
