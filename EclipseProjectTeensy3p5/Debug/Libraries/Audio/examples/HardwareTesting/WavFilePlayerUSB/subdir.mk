...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/HardwareTesting/WavFilePlayerUSB/WavFilePlayerUSB.ino 

OBJS += \
./Libraries/Audio/examples/HardwareTesting/WavFilePlayerUSB/WavFilePlayerUSB.o 

INO_DEPS += \
./Libraries/Audio/examples/HardwareTesting/WavFilePlayerUSB/WavFilePlayerUSB.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Audio/examples/HardwareTesting/WavFilePlayerUSB/WavFilePlayerUSB.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/HardwareTesting/WavFilePlayerUSB/WavFilePlayerUSB.ino
	@echo 'Building file: $<'
