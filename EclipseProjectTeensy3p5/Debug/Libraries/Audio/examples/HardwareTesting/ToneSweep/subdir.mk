...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/HardwareTesting/ToneSweep/ToneSweep.ino 

OBJS += \
./Libraries/Audio/examples/HardwareTesting/ToneSweep/ToneSweep.o 

INO_DEPS += \
./Libraries/Audio/examples/HardwareTesting/ToneSweep/ToneSweep.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Audio/examples/HardwareTesting/ToneSweep/ToneSweep.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/HardwareTesting/ToneSweep/ToneSweep.ino
	@echo 'Building file: $<'
