...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/HardwareTesting/PassThroughMono/PassThroughMono.ino 

OBJS += \
./Libraries/Audio/examples/HardwareTesting/PassThroughMono/PassThroughMono.o 

INO_DEPS += \
./Libraries/Audio/examples/HardwareTesting/PassThroughMono/PassThroughMono.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Audio/examples/HardwareTesting/PassThroughMono/PassThroughMono.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/HardwareTesting/PassThroughMono/PassThroughMono.ino
	@echo 'Building file: $<'
