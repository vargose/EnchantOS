...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/HardwareTesting/PassThroughUSB/PassThroughUSB.ino 

OBJS += \
./Libraries/Audio/examples/HardwareTesting/PassThroughUSB/PassThroughUSB.o 

INO_DEPS += \
./Libraries/Audio/examples/HardwareTesting/PassThroughUSB/PassThroughUSB.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Audio/examples/HardwareTesting/PassThroughUSB/PassThroughUSB.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/HardwareTesting/PassThroughUSB/PassThroughUSB.ino
	@echo 'Building file: $<'
