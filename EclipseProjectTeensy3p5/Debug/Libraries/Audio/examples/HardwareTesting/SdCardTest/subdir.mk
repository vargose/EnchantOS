...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/HardwareTesting/SdCardTest/SdCardTest.ino 

OBJS += \
./Libraries/Audio/examples/HardwareTesting/SdCardTest/SdCardTest.o 

INO_DEPS += \
./Libraries/Audio/examples/HardwareTesting/SdCardTest/SdCardTest.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Audio/examples/HardwareTesting/SdCardTest/SdCardTest.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/HardwareTesting/SdCardTest/SdCardTest.ino
	@echo 'Building file: $<'
