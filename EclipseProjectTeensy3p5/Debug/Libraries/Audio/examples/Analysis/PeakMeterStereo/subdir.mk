...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/Analysis/PeakMeterStereo/PeakMeterStereo.ino 

OBJS += \
./Libraries/Audio/examples/Analysis/PeakMeterStereo/PeakMeterStereo.o 

INO_DEPS += \
./Libraries/Audio/examples/Analysis/PeakMeterStereo/PeakMeterStereo.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Audio/examples/Analysis/PeakMeterStereo/PeakMeterStereo.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/Analysis/PeakMeterStereo/PeakMeterStereo.ino
	@echo 'Building file: $<'
