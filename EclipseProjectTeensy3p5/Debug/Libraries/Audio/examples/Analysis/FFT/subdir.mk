...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/Analysis/FFT/FFT.ino 

OBJS += \
./Libraries/Audio/examples/Analysis/FFT/FFT.o 

INO_DEPS += \
./Libraries/Audio/examples/Analysis/FFT/FFT.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Audio/examples/Analysis/FFT/FFT.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/Analysis/FFT/FFT.ino
	@echo 'Building file: $<'
