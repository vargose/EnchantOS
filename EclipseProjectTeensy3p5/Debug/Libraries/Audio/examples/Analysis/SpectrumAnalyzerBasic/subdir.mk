...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/Analysis/SpectrumAnalyzerBasic/SpectrumAnalyzerBasic.ino 

OBJS += \
./Libraries/Audio/examples/Analysis/SpectrumAnalyzerBasic/SpectrumAnalyzerBasic.o 

INO_DEPS += \
./Libraries/Audio/examples/Analysis/SpectrumAnalyzerBasic/SpectrumAnalyzerBasic.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Audio/examples/Analysis/SpectrumAnalyzerBasic/SpectrumAnalyzerBasic.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/Analysis/SpectrumAnalyzerBasic/SpectrumAnalyzerBasic.ino
	@echo 'Building file: $<'
