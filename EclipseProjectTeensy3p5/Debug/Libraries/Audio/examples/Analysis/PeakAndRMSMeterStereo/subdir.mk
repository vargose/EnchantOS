...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/Analysis/PeakAndRMSMeterStereo/PeakAndRMSMeterStereo.ino 

OBJS += \
./Libraries/Audio/examples/Analysis/PeakAndRMSMeterStereo/PeakAndRMSMeterStereo.o 

INO_DEPS += \
./Libraries/Audio/examples/Analysis/PeakAndRMSMeterStereo/PeakAndRMSMeterStereo.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Audio/examples/Analysis/PeakAndRMSMeterStereo/PeakAndRMSMeterStereo.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/Analysis/PeakAndRMSMeterStereo/PeakAndRMSMeterStereo.ino
	@echo 'Building file: $<'
