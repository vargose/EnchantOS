...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/Analysis/DialTone_Serial/DialTone_Serial.ino 

OBJS += \
./Libraries/Audio/examples/Analysis/DialTone_Serial/DialTone_Serial.o 

INO_DEPS += \
./Libraries/Audio/examples/Analysis/DialTone_Serial/DialTone_Serial.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Audio/examples/Analysis/DialTone_Serial/DialTone_Serial.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/Analysis/DialTone_Serial/DialTone_Serial.ino
	@echo 'Building file: $<'
