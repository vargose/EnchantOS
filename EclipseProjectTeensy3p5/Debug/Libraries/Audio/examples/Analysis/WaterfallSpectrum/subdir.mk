...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/Analysis/WaterfallSpectrum/WaterfallSpectrum.ino 

OBJS += \
./Libraries/Audio/examples/Analysis/WaterfallSpectrum/WaterfallSpectrum.o 

INO_DEPS += \
./Libraries/Audio/examples/Analysis/WaterfallSpectrum/WaterfallSpectrum.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Audio/examples/Analysis/WaterfallSpectrum/WaterfallSpectrum.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/Analysis/WaterfallSpectrum/WaterfallSpectrum.ino
	@echo 'Building file: $<'
