...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/Analysis/PeakMeterMono/PeakMeterMono.ino 

OBJS += \
./Libraries/Audio/examples/Analysis/PeakMeterMono/PeakMeterMono.o 

INO_DEPS += \
./Libraries/Audio/examples/Analysis/PeakMeterMono/PeakMeterMono.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Audio/examples/Analysis/PeakMeterMono/PeakMeterMono.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/Analysis/PeakMeterMono/PeakMeterMono.ino
	@echo 'Building file: $<'
