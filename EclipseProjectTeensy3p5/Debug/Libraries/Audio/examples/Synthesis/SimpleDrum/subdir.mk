...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/Synthesis/SimpleDrum/SimpleDrum.ino 

OBJS += \
./Libraries/Audio/examples/Synthesis/SimpleDrum/SimpleDrum.o 

INO_DEPS += \
./Libraries/Audio/examples/Synthesis/SimpleDrum/SimpleDrum.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Audio/examples/Synthesis/SimpleDrum/SimpleDrum.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/Synthesis/SimpleDrum/SimpleDrum.ino
	@echo 'Building file: $<'
