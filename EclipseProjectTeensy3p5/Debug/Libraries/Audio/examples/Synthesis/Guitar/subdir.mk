...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/Synthesis/Guitar/Guitar.ino 

OBJS += \
./Libraries/Audio/examples/Synthesis/Guitar/Guitar.o 

INO_DEPS += \
./Libraries/Audio/examples/Synthesis/Guitar/Guitar.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Audio/examples/Synthesis/Guitar/Guitar.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/Synthesis/Guitar/Guitar.ino
	@echo 'Building file: $<'
