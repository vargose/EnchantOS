...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/Synthesis/pulseWidth/pulseWidth.ino 

OBJS += \
./Libraries/Audio/examples/Synthesis/pulseWidth/pulseWidth.o 

INO_DEPS += \
./Libraries/Audio/examples/Synthesis/pulseWidth/pulseWidth.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Audio/examples/Synthesis/pulseWidth/pulseWidth.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/Synthesis/pulseWidth/pulseWidth.ino
	@echo 'Building file: $<'
