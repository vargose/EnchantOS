...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/WavFilePlayer/WavFilePlayer.ino 

OBJS += \
./Libraries/Audio/examples/WavFilePlayer/WavFilePlayer.o 

INO_DEPS += \
./Libraries/Audio/examples/WavFilePlayer/WavFilePlayer.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Audio/examples/WavFilePlayer/WavFilePlayer.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/WavFilePlayer/WavFilePlayer.ino
	@echo 'Building file: $<'
