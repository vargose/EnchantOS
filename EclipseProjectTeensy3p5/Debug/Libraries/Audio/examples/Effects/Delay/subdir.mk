...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/Effects/Delay/Delay.ino 

OBJS += \
./Libraries/Audio/examples/Effects/Delay/Delay.o 

INO_DEPS += \
./Libraries/Audio/examples/Effects/Delay/Delay.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Audio/examples/Effects/Delay/Delay.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/Effects/Delay/Delay.ino
	@echo 'Building file: $<'
