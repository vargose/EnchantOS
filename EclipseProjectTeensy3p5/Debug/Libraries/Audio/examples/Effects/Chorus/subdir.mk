...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/Effects/Chorus/Chorus.ino 

OBJS += \
./Libraries/Audio/examples/Effects/Chorus/Chorus.o 

INO_DEPS += \
./Libraries/Audio/examples/Effects/Chorus/Chorus.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Audio/examples/Effects/Chorus/Chorus.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/Effects/Chorus/Chorus.ino
	@echo 'Building file: $<'
