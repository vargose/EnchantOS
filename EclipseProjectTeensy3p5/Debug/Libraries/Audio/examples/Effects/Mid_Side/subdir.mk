...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/Effects/Mid_Side/Mid_Side.ino 

OBJS += \
./Libraries/Audio/examples/Effects/Mid_Side/Mid_Side.o 

INO_DEPS += \
./Libraries/Audio/examples/Effects/Mid_Side/Mid_Side.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Audio/examples/Effects/Mid_Side/Mid_Side.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/Effects/Mid_Side/Mid_Side.ino
	@echo 'Building file: $<'
