...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/Effects/Filter/Filter.ino 

OBJS += \
./Libraries/Audio/examples/Effects/Filter/Filter.o 

INO_DEPS += \
./Libraries/Audio/examples/Effects/Filter/Filter.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Audio/examples/Effects/Filter/Filter.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/Effects/Filter/Filter.ino
	@echo 'Building file: $<'
