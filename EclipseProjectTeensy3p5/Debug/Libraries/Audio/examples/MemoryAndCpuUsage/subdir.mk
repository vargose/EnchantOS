...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/MemoryAndCpuUsage/MemoryAndCpuUsage.ino 

OBJS += \
./Libraries/Audio/examples/MemoryAndCpuUsage/MemoryAndCpuUsage.o 

INO_DEPS += \
./Libraries/Audio/examples/MemoryAndCpuUsage/MemoryAndCpuUsage.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Audio/examples/MemoryAndCpuUsage/MemoryAndCpuUsage.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/MemoryAndCpuUsage/MemoryAndCpuUsage.ino
	@echo 'Building file: $<'
