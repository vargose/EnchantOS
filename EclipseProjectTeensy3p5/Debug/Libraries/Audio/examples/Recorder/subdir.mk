...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/Recorder/Recorder.ino 

OBJS += \
./Libraries/Audio/examples/Recorder/Recorder.o 

INO_DEPS += \
./Libraries/Audio/examples/Recorder/Recorder.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Audio/examples/Recorder/Recorder.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Audio/examples/Recorder/Recorder.ino
	@echo 'Building file: $<'
