...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Wire/examples/slave_sender/slave_sender.ino 

OBJS += \
./Libraries/Wire/examples/slave_sender/slave_sender.o 

INO_DEPS += \
./Libraries/Wire/examples/slave_sender/slave_sender.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Wire/examples/slave_sender/slave_sender.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Wire/examples/slave_sender/slave_sender.ino
	@echo 'Building file: $<'
