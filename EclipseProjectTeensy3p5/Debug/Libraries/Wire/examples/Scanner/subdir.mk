...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Wire/examples/Scanner/Scanner.ino 

OBJS += \
./Libraries/Wire/examples/Scanner/Scanner.o 

INO_DEPS += \
./Libraries/Wire/examples/Scanner/Scanner.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Wire/examples/Scanner/Scanner.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Wire/examples/Scanner/Scanner.ino
	@echo 'Building file: $<'
