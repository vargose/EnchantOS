...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Wire/examples/master_writer/master_writer.ino 

OBJS += \
./Libraries/Wire/examples/master_writer/master_writer.o 

INO_DEPS += \
./Libraries/Wire/examples/master_writer/master_writer.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Wire/examples/master_writer/master_writer.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Wire/examples/master_writer/master_writer.ino
	@echo 'Building file: $<'
