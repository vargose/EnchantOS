...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Wire/examples/slave_receiver/slave_receiver.ino 

OBJS += \
./Libraries/Wire/examples/slave_receiver/slave_receiver.o 

INO_DEPS += \
./Libraries/Wire/examples/slave_receiver/slave_receiver.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Wire/examples/slave_receiver/slave_receiver.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Wire/examples/slave_receiver/slave_receiver.ino
	@echo 'Building file: $<'
