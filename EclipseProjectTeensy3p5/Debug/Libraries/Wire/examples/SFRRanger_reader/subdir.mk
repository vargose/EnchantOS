...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Wire/examples/SFRRanger_reader/SFRRanger_reader.ino 

OBJS += \
./Libraries/Wire/examples/SFRRanger_reader/SFRRanger_reader.o 

INO_DEPS += \
./Libraries/Wire/examples/SFRRanger_reader/SFRRanger_reader.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Wire/examples/SFRRanger_reader/SFRRanger_reader.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Wire/examples/SFRRanger_reader/SFRRanger_reader.ino
	@echo 'Building file: $<'
