...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Wire/examples/master_reader/master_reader.ino 

OBJS += \
./Libraries/Wire/examples/master_reader/master_reader.o 

INO_DEPS += \
./Libraries/Wire/examples/master_reader/master_reader.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Wire/examples/master_reader/master_reader.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/Wire/examples/master_reader/master_reader.ino
	@echo 'Building file: $<'
