...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/EEPROM/examples/eeprom_read/eeprom_read.ino 
...
Libraries/EEPROM/examples/eeprom_read/eeprom_read.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/EEPROM/examples/eeprom_read/eeprom_read.ino
	@echo 'Building file: $<'
