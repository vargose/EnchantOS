...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/EEPROM/examples/eeprom_crc/eeprom_crc.ino 

OBJS += \
./Libraries/EEPROM/examples/eeprom_crc/eeprom_crc.o 

INO_DEPS += \
./Libraries/EEPROM/examples/eeprom_crc/eeprom_crc.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/EEPROM/examples/eeprom_crc/eeprom_crc.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/EEPROM/examples/eeprom_crc/eeprom_crc.ino
	@echo 'Building file: $<'
