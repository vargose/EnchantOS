...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/EEPROM/examples/eeprom_get/eeprom_get.ino 

OBJS += \
./Libraries/EEPROM/examples/eeprom_get/eeprom_get.o 

INO_DEPS += \
./Libraries/EEPROM/examples/eeprom_get/eeprom_get.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/EEPROM/examples/eeprom_get/eeprom_get.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/EEPROM/examples/eeprom_get/eeprom_get.ino
	@echo 'Building file: $<'
