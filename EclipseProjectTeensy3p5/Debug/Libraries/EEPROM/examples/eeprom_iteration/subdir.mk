...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/EEPROM/examples/eeprom_iteration/eeprom_iteration.ino 

OBJS += \
./Libraries/EEPROM/examples/eeprom_iteration/eeprom_iteration.o 

INO_DEPS += \
./Libraries/EEPROM/examples/eeprom_iteration/eeprom_iteration.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/EEPROM/examples/eeprom_iteration/eeprom_iteration.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/EEPROM/examples/eeprom_iteration/eeprom_iteration.ino
	@echo 'Building file: $<'
