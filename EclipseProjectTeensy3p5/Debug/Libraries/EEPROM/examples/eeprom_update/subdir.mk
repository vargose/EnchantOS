...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/EEPROM/examples/eeprom_update/eeprom_update.ino 

OBJS += \
./Libraries/EEPROM/examples/eeprom_update/eeprom_update.o 

INO_DEPS += \
./Libraries/EEPROM/examples/eeprom_update/eeprom_update.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/EEPROM/examples/eeprom_update/eeprom_update.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/EEPROM/examples/eeprom_update/eeprom_update.ino
	@echo 'Building file: $<'
