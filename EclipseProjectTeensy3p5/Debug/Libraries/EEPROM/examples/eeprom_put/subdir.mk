...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/EEPROM/examples/eeprom_put/eeprom_put.ino 

OBJS += \
./Libraries/EEPROM/examples/eeprom_put/eeprom_put.o 

INO_DEPS += \
./Libraries/EEPROM/examples/eeprom_put/eeprom_put.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/EEPROM/examples/eeprom_put/eeprom_put.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/EEPROM/examples/eeprom_put/eeprom_put.ino
	@echo 'Building file: $<'
